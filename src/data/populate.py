...
class Populator(object):
    ...
    def get_tables(self):
        ...
        log.log('Exising table list = ' + str(self.tablenames))
    ...
    def create_table(self, tablename):
        ...
        if not self.scrip_info:
            ...
            log.log("M_SCRIP_INFO table created")
        ...
        if (symbol, instru_type) not in self.scrips:
            ...
            log.log("Entry created for " + tablename + " in M_SCRIP_INFO")
        ...
        self.dbops.create(spec)
        log.log("Table created for " + tablename)
